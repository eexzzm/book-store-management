...
public class kelolaAdmin extends javax.swing.JFrame {
    ...
    private void hapusBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusBtnActionPerformed
        ...
        int confirm = JOptionPane.showConfirmDialog(this, "Apakah anda yakin ingin menghapus " + judulBuku, "Konfirmasi", JOptionPane.YES_NO_OPTION);
        System.out.print(idBuku);
        
        if(confirm == JOptionPane.YES_OPTION) {
            try {
                ResponDatabase response = db.hapusBuku(Integer.parseInt(idBuku));
                if(response.message == "sukses") {
                    JOptionPane.showMessageDialog(this, "Berhasil menghapus buku dengan idBuku: " + idBuku);
                    getData();
                } else {
    ...
    private void tambahBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahBtnActionPerformed
        ...
        String penulis = penulisTf.getText();
